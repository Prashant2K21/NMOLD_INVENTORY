...
if($type === 'supplier'){
    ...
    $stmt = $conn->prepare("SELECT suppliers.id as sid,suppliers.created_at as screatedat, users.first_name, users.last_name,suppliers.supplier_location, suppliers.email, suppliers.created_by
