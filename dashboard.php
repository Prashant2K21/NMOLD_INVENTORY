...
<head>
  ...
  <style>
    ...
    .card {
      ...
      overflow: hidden;
      /* Ensure content within the card stays contained */
    ...
    .card-link {
      ...
      /* Display the link as inline block */
      text-decoration: none;
      /* Remove underline */
      color: #007bff;
      /* Set the color of the link */
      margin-top: 10px;
      /* Add spacing between text and link */
      padding: 5px 10px;
        ...
        <div class="dashboard_content_main">
          <div class="card">
            ...
            <div class="card-content">
              ...
              <a href="dashboard1.php" class="card-link">Analytics</a>
            </div>
          </div>
